...
module_socials_youtube_channel_new_post = "Hey @everyone! **{youtube_channel_handle}** as posted a new video titled: **{video_title}** on YouTube: {video_link}"
unknown = "Unknown"
meme_footer = "Visit to Reddit to view top new memes!"
meme_failed = "Something went wrong while getting your meme!"
meme_delivered = "Here is your random meme!"
