...
response_reminder_add_failed_not_a_valid_url = (
    "Oops! It looks like the given string is not a URL!"
)
response_reminder_added = "I have added the reminder!"
response_reminder_add_failed = (
    "I am sorry! Something went wrong while trying to add the reminder!"
)
...
response_reminder_delete_failed = (
    "I am sorry! Something went wrong while trying to delete the reminder!"
)
