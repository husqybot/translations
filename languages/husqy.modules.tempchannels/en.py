...
response_tempchannel_edit_block_failed_not_a_tempchannel = "I am sorry! Something went wrong while trying to block the user(s), the given channel is not a tempchannel!"
...
response_tempchannel_edit_transfer_failed_not_a_tempchannel = "I am sorry! Something went wrong while trying to transfer the ownership, the given channel is not a tempchannel!"
...
response_tempchannel_edit_unblock_failed_not_a_tempchannel = "I am sorry! Something went wrong while trying to unblock the user(s), the given channel is not a tempchannel!"
