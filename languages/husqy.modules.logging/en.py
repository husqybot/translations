...
response_module_autoresponder_create_entry_failed = (
    "{datetime} -- **{member}** tried to create an entry for the `autoresponder` module but something went wrong!"
)
### Delete
response_module_autoresponder_delete_entry_success = (
    "{datetime} -- **{member}** has deleted an entry from the `autoresponder` module!"
)
response_module_autoresponder_delete_entry_failed = (
...
response_tempchannel_edit_user_limit_success = (
    "{datetime} -- **{member}** changed the user limit of a temporary channel to `{user_limit} users`!"
)
response_tempchannel_edit_user_limit_off_success = (
    "{datetime} -- **{member}** turned off the user limit of a temporary channel!"
)
response_tempchannel_edit_user_limit_failed = (
    "{datetime} -- **{member}** tried to change the user limit of a temporary channel but something went wrong!"
)
...
response_tempchannel_edit_user_limit_failed_not_a_valid_number = (
    "{datetime} -- **{member}** tried to change the user limit of a temporary channel but didn't insert a valid number!"
)
...
response_tempchannel_edit_transfer_success = "{datetime} -- **{member}** transferred ownership of a temporary channel!"
response_tempchannel_edit_transfer_failed = (
    "{datetime} -- **{member}** tried to transfer ownership of a temporary channel but something went wrong!"
)
...
response_tempchannel_edit_transfer_cancelled = (
    "{datetime} -- **{member}** cancelled the ownership transfer of a temporary channel!"
)
...
response_tempchannel_edit_slowmode_success = (
    "{datetime} -- **{member}** changed the slowmode delay of a temporary channel to `{slowmode} seconds`!"
)
response_tempchannel_edit_slowmode_off_success = (
    "{datetime} -- **{member}** turned off the slowmode of a temporary channel!"
)
response_tempchannel_edit_slowmode_failed = (
    "{datetime} -- **{member}** tried to change the slowmode delay of a temporary channel but something went wrong!"
)
...
### Onlyfor
response_tempchannel_onlyfor_block_success = "{datetime} -- **{member}** has limited a temporary channel to a role!"
response_tempchannel_onlyfor_block_failed = (
    "{datetime} -- **{member}** tried to limit a temporary channel to a role but something went wrong!"
)
...
### Block
response_tempchannel_edit_block_success = "{datetime} -- **{member}** has blocked users from a temporary channel!"
response_tempchannel_edit_block_failed = (
    "{datetime} -- **{member}** tried to block one or more users from a temporary channel but something went wrong!"
)
...
### Unblock
response_tempchannel_edit_unblock_success = "{datetime} -- **{member}** has unblocked users from a temporary channel!"
response_tempchannel_edit_unblock_failed = (
    "{datetime} -- **{member}** tried to unblock one or more users from a temporary channel but something went wrong!"
)
...
### Claim
response_tempchannel_edit_claim_success = "{datetime} -- **{member}** claimed ownership of a temporary channel!"
response_tempchannel_edit_claim_failed = (
    "{datetime} -- **{member}** tried to claim ownership of a temporary channel but something went wrong!"
)
response_tempchannel_edit_claim_cancelled = (
    "{datetime} -- **{member}** cancelled the ownership claim of a temporary channel!"
)
response_tempchannel_edit_claim_not_possible = (
    "{datetime} -- **{member}** tried to claim ownership of a temporary channel but there was still an owner!"
)
...
response_tempchannel_edit_name_failed = (
    "{datetime} -- **{member}** tried to edit the name of a temporary channel but something went wrong!"
)
...
response_module_tempchannel_enable_failed = (
    "{datetime} -- **{member}** tried to enable the `tempchannel` module but something went wrong!"
)
### Enable
response_module_tempchannel_settings_changed = (
    "{datetime} -- **{member}** has changed the settings of the `tempchannel` module!"
)
response_module_tempchannel_settings_changed_failed = (
    "{datetime} -- **{member}** tried to change the settings of the `tempchannel` module but something went wrong!"
)

## Module Greetings
### Disable
response_module_greetings_disabled = (
    "{datetime} -- **{member}** has disabled the `greetings` module! All related settings are removed!"
)
...
response_module_greetings_enable_failed = (
    "{datetime} -- **{member}** tried to enable the `greetings` module but something went wrong!"
)
### Settings
...
### Create
response_module_reactionroles_reactionrole_created = "{datetime} -- **{member}** created a reactionrole!"
...
### Twitch
response_module_twitch_added = (
    "{datetime} -- **{member}** added Twitch account: `{twitch_account}` to the configuration of the `socials` module!"
)
...
response_module_rss_added = (
    "{datetime} -- **{member}** added the RSS Feed: `{feed}` to the configuration of the `socials` module!"
)
...
response_module_rss_removed = (
    "{datetime} -- **{member}** removed RSS Feed: `{feed}` from the configuration of the `socials` module!"
)
...
response_module_reddit_added = (
    "{datetime} -- **{member}** added Subreddit: `{subreddit}` to the configuration of the `socials` module!"
)
...
response_module_reddit_removed = (
    "{datetime} -- **{member}** removed Subreddit: `{subreddit}` from the configuration of the `socials` module!"
)
...
### Create
response_tag_create_success = "{datetime} -- **{member}** has created a tag named `{tag_name}`!"
response_tag_create_failed = (
    "{datetime} -- **{member}** tried to create a tag named `{tag_name}` but something went wrong!"
)
response_tag_create_failed_already_exists = (
    "{datetime} -- **{member}** tried to create a tag named `{tag_name}` but that name already exists!"
)
### Delete
...
response_tag_delete_failed_tag_does_not_exist = (
    "{datetime} -- **{member}** tried to delete the tag `{tag_name}` but that tag did not exist!"
)
### Edit
response_tag_edit_success = "{datetime} -- **{member}** edited a tag named `{tag_name}`!"
response_tag_edit_failed = "{datetime} -- **{member}** tried to edit a tag named `{tag_name}` but something went wrong!"
response_tag_edit_failed_tag_does_not_exist = (
    "{datetime} -- **{member}** tried to edit a tag with ID `{tag_id}` but that tag does not exist!"
)
### Send
response_tag_send_success = "{datetime} -- **{member}** used the tag `{tag_name}`!"
response_tag_send_failed_no_such_tag = (
    "{datetime} -- **{member}** tried to send a tag with the name `{tag_name}` but it does not exist!"
)
