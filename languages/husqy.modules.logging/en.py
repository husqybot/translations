...
### Info
response_info_failed = (
    "{datetime} -- **{member}** requested information but something went wrong!"
)
...
### Enable
response_module_tempchannels_enabled = (
    "{datetime} -- **{member}** has enabled the `tempchannels` module!"
)
response_module_tempchannels_enable_failed = "{datetime} -- **{member}** tried to enable the `tempchannels` module but something went wrong!"
### Creation channels
response_module_tempchannels_creation_channel_created = "{datetime} -- **{member}** has created a new tempchannels creation channel: <#{channel_id}>!"
response_module_tempchannels_creation_channel_create_failed = "{datetime} -- **{member}** tried to create a new tempchannels creation channel but something went wrong!"
...
response_module_tempchannels_creation_channel_delete_failed = "{datetime} -- **{member}** tried to delete a tempchannels creation channel but something went wrong!"
response_module_tempchannels_creation_channel_edited = (
    "{datetime} -- **{member}** has edited a tempchannels creation channel!"
)
response_module_tempchannels_creation_channel_edit_failed = "{datetime} -- **{member}** tried to edit a tempchannels creation channel but something went wrong!"
...
# Check create
response_module_tempchannels_check_create_success = "{datetime} -- Checked channel join for tempchannel creation. Triggered by: {member}"
response_module_tempchannels_check_create_failed = "{datetime} -- Checking channel join for tempchannel creation failed. Triggered by: {member}"
...
# Edits
## Name
response_module_tempchannels_edit_name_success = (
    "{datetime} -- **{member}** has changed the name of a tempchannel!"
)
response_module_tempchannels_edit_name_failed = "{datetime} -- **{member}** tried to change the name of a tempchannel but something went wrong!"
response_module_tempchannels_edit_name_failed_not_owner = "{datetime} -- **{member}** tried to change the name of a tempchannel but they are not the owner!"
response_module_tempchannels_edit_name_failed_no_tempchannel_found = "{datetime} -- **{member}** tried to change the name of a tempchannel but the given tempchannel is not found!"
response_module_tempchannels_edit_name_failed_module_disabled = "{datetime} -- **{member}** tried to change the name of a tempchannel but `tempchannels` module is disabled!"
...
## Region
response_module_tempchannels_edit_region_success = (
    "{datetime} -- **{member}** has changed the region of a tempchannel!"
)
response_module_tempchannels_edit_region_failed = "{datetime} -- **{member}** tried to change the region of a tempchannel but something went wrong!"
response_module_tempchannels_edit_region_failed_not_owner = "{datetime} -- **{member}** tried to change the region of a tempchannel but they are not the owner!"
response_module_tempchannels_edit_region_failed_no_tempchannel_found = "{datetime} -- **{member}** tried to change the region of a tempchannel but the given tempchannel is not found!"
response_module_tempchannels_edit_region_failed_module_disabled = "{datetime} -- **{member}** tried to change the region of a tempchannel but `tempchannels` module is disabled!"
...
response_module_tempchannels_edit_slowmode_failed = "{datetime} -- **{member}** tried to change the slowmode timeout of a tempchannel but something went wrong!"
response_module_tempchannels_edit_slowmode_failed_not_owner = "{datetime} -- **{member}** tried to change the slowmode timeout of a tempchannel but they are not the owner!"
...
response_module_tempchannels_edit_bitrate_failed = "{datetime} -- **{member}** tried to change the bitrate of a tempchannel but something went wrong!"
...
response_module_tempchannels_edit_bitrate_failed_not_owner = "{datetime} -- **{member}** tried to change the bitrate of a tempchannel but they are not the owner!"
response_module_tempchannels_edit_bitrate_failed_no_tempchannel_found = "{datetime} -- **{member}** tried to change the bitrate of a tempchannel but the given tempchannel is not found!"
response_module_tempchannels_edit_bitrate_failed_module_disabled = "{datetime} -- **{member}** tried to change the bitrate of a tempchannel but `tempchannels` module is disabled!"
...
response_module_tempchannels_edit_user_limit_failed = "{datetime} -- **{member}** tried to change the user limit of a tempchannel but something went wrong!"
...
response_module_tempchannels_edit_user_limit_failed_not_owner = "{datetime} -- **{member}** tried to change the user limit of a tempchannel but they are not the owner!"
response_module_tempchannels_edit_user_limit_failed_no_tempchannel_found = "{datetime} -- **{member}** tried to change the user limit of a tempchannel but the given tempchannel is not found!"
response_module_tempchannels_edit_user_limit_failed_module_disabled = "{datetime} -- **{member}** tried to change the user limit of a tempchannel but `tempchannels` module is disabled!"
...
## Age restriction
response_module_tempchannels_edit_age_restriction_success = "{datetime} -- **{member}** has changed the age restiction setting of a tempchannel!"
response_module_tempchannels_edit_age_restriction_failed = "{datetime} -- **{member}** tried to change the age restiction setting of a tempchannel but something went wrong!"
response_module_tempchannels_edit_age_restriction_failed_not_owner = "{datetime} -- **{member}** tried to change the age restiction setting of a tempchannel but they are not the owner!"
...
## Transfer
response_module_tempchannels_transfer_success = (
    "{datetime} -- **{member}** has transferred ownership of a tempchannel!"
)
response_module_tempchannels_transfer_failed = "{datetime} -- **{member}** tried to transfer ownership of a tempchannel but something went wrong!"
...
response_module_tempchannels_transfer_failed_not_owner = "{datetime} -- **{member}** tried to transfer ownership of a tempchannel but they are not the owner!"
response_module_tempchannels_transfer_failed_no_tempchannel_found = "{datetime} -- **{member}** tried to transfer ownership of a tempchannel but the given tempchannel is not found!"
response_module_tempchannels_transfer_failed_module_disabled = "{datetime} -- **{member}** tried to transfer ownership of a tempchannel but `tempchannels` module is disabled!"
...
## Claim
response_module_tempchannels_claim_success = (
    "{datetime} -- **{member}** has claimed ownership of a tempchannel!"
)
response_module_tempchannels_claim_failed = "{datetime} -- **{member}** tried to claim ownership of a tempchannel but something went wrong!"
response_module_tempchannels_claim_failed_data_collection_enabled = "{datetime} -- **{member}** tried to claim ownership of a tempchannel but they have data collection disabled!"
response_module_tempchannels_claim_failed_owner_linked = "{datetime} -- **{member}** tried to claim ownership of a tempchannel but there is still an owner linked!"
response_module_tempchannels_claim_failed_no_tempchannel_found = "{datetime} -- **{member}** tried to claim ownership of a tempchannel but the given tempchannel is not found!"
response_module_tempchannels_claim_failed_module_disabled = "{datetime} -- **{member}** tried to claim ownership of a tempchannel but `tempchannels` module is disabled!"
...
## Delete
response_module_tempchannels_delete_success = (
    "{datetime} -- **{member}** has deleted a tempchannel set!"
)
response_module_tempchannels_delete_failed = "{datetime} -- **{member}** tried to delete a tempchannel set but something went wrong!"
response_module_tempchannels_delete_failed_not_owner = "{datetime} -- **{member}** tried to delete a tempchannel set but they are not the owner!"
response_module_tempchannels_delete_failed_no_tempchannel_found = "{datetime} -- **{member}** tried to delete a tempchannel set but the given tempchannel is not found!"
response_module_tempchannels_delete_failed_module_disabled = "{datetime} -- **{member}** tried to delete a tempchannel set but `tempchannels` module is disabled!"
...
response_module_tempchannels_trust_rule_add_failed = "{datetime} -- **{member}** tried to add a trust rule to a tempchannel but something went wrong!"
response_module_tempchannels_trust_rule_add_failed_not_owner = "{datetime} -- **{member}** tried to add a trust rule to a tempchannel but they are not the owner!"
response_module_tempchannels_trust_rule_add_failed_no_tempchannel_found = "{datetime} -- **{member}** tried to add a trust rule to a tempchannel but the given tempchannel is not found!"
response_module_tempchannels_trust_rule_add_failed_module_disabled = "{datetime} -- **{member}** tried to add a trust rule to a tempchannel but `tempchannels` module is disabled!"
...
response_module_tempchannels_trust_rule_delete_failed = "{datetime} -- **{member}** tried to delete a trust rule from a tempchannel but something went wrong!"
response_module_tempchannels_trust_rule_delete_failed_not_owner = "{datetime} -- **{member}** tried to delete a trust rule from a tempchannel but they are not the owner!"
response_module_tempchannels_trust_rule_delete_failed_no_tempchannel_found = "{datetime} -- **{member}** tried to delete a trust rule from a tempchannel but the given tempchannel is not found!"
response_module_tempchannels_trust_rule_delete_failed_module_disabled = "{datetime} -- **{member}** tried to delete a trust rule from a tempchannel but `tempchannels` module is disabled!"
...
response_module_tempchannels_block_rule_add_failed = "{datetime} -- **{member}** tried to add a block rule to a tempchannel but something went wrong!"
response_module_tempchannels_block_rule_add_failed_not_owner = "{datetime} -- **{member}** tried to add a block rule to a tempchannel but they are not the owner!"
response_module_tempchannels_block_rule_add_failed_no_tempchannel_found = "{datetime} -- **{member}** tried to add a block rule to a tempchannel but the given tempchannel is not found!"
response_module_tempchannels_block_rule_add_failed_module_disabled = "{datetime} -- **{member}** tried to add a block rule to a tempchannel but `tempchannels` module is disabled!"
...
response_module_tempchannels_block_rule_delete_failed = "{datetime} -- **{member}** tried to delete a block rule from a tempchannel but something went wrong!"
response_module_tempchannels_block_rule_delete_failed_not_owner = "{datetime} -- **{member}** tried to delete a block rule from a tempchannel but they are not the owner!"
response_module_tempchannels_block_rule_delete_failed_no_tempchannel_found = "{datetime} -- **{member}** tried to delete a block rule from a tempchannel but the given tempchannel is not found!"
response_module_tempchannels_block_rule_delete_failed_module_disabled = "{datetime} -- **{member}** tried to delete a block rule from a tempchannel but `tempchannels` module is disabled!"
...
### Create
response_module_reactionroles_reactionrole_panel_created = (
    "{datetime} -- **{member}** created a reactionrole panel!"
)
response_module_reactionroles_reactionrole_panel_create_failed = "{datetime} -- **{member}** tried to create a reactionrole panel but someting went wrong!"
response_module_reactionroles_reactionrole_panel_create_failed_panel_limit_reached = "{datetime} -- **{member}** tried to create a reactionrole panel but the panel limit has been reached!"
response_module_reactionroles_reactionrole_panel_create_failed_incorrect_panel_type = "{datetime} -- **{member}** tried to create a reactionrole panel but they didn't provide a correct panel type!"
### Delete
response_module_reactionroles_reactionrole_panel_deleted = "{datetime} -- **{member}** deleted a reactionrole panel! Any leftovers can safely be removed!"
response_module_reactionroles_reactionrole_panel_delete_failed = "{datetime} -- **{member}** tried to delete a reactionrole panel but someting went wrong!"
### Edit
response_module_reactionroles_reactionrole_panel_edited = (
    "{datetime} -- **{member}** edited a reactionrole panel!"
)
response_module_reactionroles_reactionrole_panel_edit_failed = "{datetime} -- **{member}** tried to edit a reactionrole panel but someting went wrong!"
response_module_reactionroles_reactionrole_panel_edit_failed_invalid_panel_type = "{datetime} -- **{member}** tried to edit a reactionrole panel but they didn't provide a correct panel type!"
### Entry added
...
response_module_reactionroles_reactionrole_entry_edit_failed = "{datetime} -- **{member}** tried to edit a reactionrole entry for a panel but something went wrong!"
...
response_tag_create_failed_prevent_data_collection_enabled = "{datetime} -- **{member}** tried to create a tag but they have disabled data collection in this server!"
### Delete
...
## Module verifier
### Disable
response_module_verifier_disabled = "{datetime} -- **{member}** has disabled the `verifier` module! All related settings are removed!"
...
### Enable
response_module_verifier_enabled = (
    "{datetime} -- **{member}** has enabled the `verifier` module!"
)
response_module_verifier_enable_failed = "{datetime} -- **{member}** tried to enable the `verifier` module but something went wrong!"
### Settings
...
### Create verification
response_module_verifier_verification_created = (
    "{datetime} -- A verification has been created for: **{member}**!"
)
response_module_verifier_verification_create_failed = "{datetime} -- Something went wrong while creating a verification for: **{member}**!"
...
response_module_verifier_verification_create_failed_invalid_member = "{datetime} -- Something went wrong while creating a verification. The target member was not valid!"
...
### Handle verifiation
response_module_verifier_verification_handle_success = (
    "{datetime} -- **{member}** has been verified!"
)
...
response_module_verifier_verification_handle_failed_already_verified = "{datetime} -- **{member}** tried to verify themself but the entry verification was already completed!"
response_module_verifier_verification_handle_failed_invalid_member = "{datetime} -- Something went wrong while handling the verification. The target member was not valid!"

## Module rules
### Disable
response_module_rules_disabled = "{datetime} -- **{member}** has disabled the `rules` module! All related settings are removed!"
...
### Enable
response_module_rules_enabled = (
    "{datetime} -- **{member}** has enabled the `rules` module!"
)
response_module_rules_enable_failed = "{datetime} -- **{member}** tried to enable the `rules` module but something went wrong!"
### Settings
response_module_rules_settings_changed = (
    "{datetime} -- **{member}** has changed the settings of the `rules` module!"
)
...
### Rule create
response_module_rules_rule_created = (
    "{datetime} -- **{member}** has created a new rule!"
)
response_module_rules_rule_create_failed = (
    "{datetime} -- **{member}** tried to create a new rule but something went wrong!"
)
response_module_rules_rule_create_failed_limit_reached = "{datetime} -- **{member}** tried to create a new rule but the limit of rules has already been reached!"
response_module_rules_rule_create_failed_not_an_administrator = "{datetime} -- **{member}** tried to create a new rule but they are not an administrator!"
response_module_rules_rule_create_failed_settings_not_found = "{datetime} -- **{member}** tried to create a new rule but the settings of the server are not found!"
### Rule delete
response_module_rules_rule_deleted = "{datetime} -- **{member}** has deleted a rule!"
response_module_rules_rule_delete_failed = (
    "{datetime} -- **{member}** tried to delete a rule but something went wrong!"
)
response_module_rules_rule_delete_failed_not_an_administrator = "{datetime} -- **{member}** tried to delete a rule but they are not an administrator!"
...
response_module_rules_rule_delete_failed_settings_not_found = "{datetime} -- **{member}** tried to delete a rule but the servers settings are not found!"
### Send check
response_module_rules_send_check_success = (
    "{datetime} -- Checking to send rules for **{member}** has been successful!"
)
response_module_rules_send_check_failed = (
    "{datetime} -- Checking to send rules for **{member}** failed!"
)
response_module_rules_send_check_failed_no_rules_found = "{datetime} -- Checking to send rules for **{member}** failed because there are no rules in this server!"
response_module_rules_send_check_failed_invalid_member = "{datetime} -- Checking to send rules for **{member}** failed the target member is not valid!"
...
response_module_rules_send_check_failed_module_disabled = "{datetime} -- Checking to send rules for **{member}** failed because the `rules` module is disabled!"
response_module_rules_send_check_failed_module_status_unknown = "{datetime} -- Checking to send rules for **{member}** failed because the status of the `rules` module is unknown!"
response_module_rules_send_check_failed_settings_not_found = "{datetime} -- Checking to send rules for **{member}** failed because the settings of the server are unknown!"
### Interaction check
